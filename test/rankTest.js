...
rankTest('voyageProfitFactor case 5 : given voyage = china, history length = 19, history include china', t => {
  const voyage = {
    zone: 'china'
  };
  const history = [{
...
rankTest('voyageProfitFactor case 6 : given voyage = east-indies , history length = 7,history include china', t => {
  const voyage = {
    zone: 'east-indies'
  };
  const history = [{
...
rankTest('voyageProfitFactor case 8 : given voyage = east-indies , history length = 15,history include china', t => {
  const voyage = {
    zone: 'east-indies'
  };
  const history = [{
